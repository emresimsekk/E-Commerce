    <%@ Page Title="" Language="C#" MasterPageFile="~/template/user/master/eticaret.Master" AutoEventWireup="true" CodeBehind="kategori.aspx.cs" Inherits="eticaret.template.user.page.kategori" %>
                   ...
                   <div class="boyut">
                             <asp:Repeater ID="rptKategori" runat="server" >
                                ...
                                <ItemTemplate>
                                         <div class="col-12 ">
                                            <div class="subMenu"> 
                                                <p><a href="altKategori.aspx?KatID=<%# Eval("KategoriID") %>&durum=0"> <%# Eval("KategoriAdi") %></a></p>
                                            </div>
                                         </div>
                                 </ItemTemplate>
                             </asp:Repeater>   
