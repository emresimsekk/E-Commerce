<%@ Page Title="" Language="C#" MasterPageFile="~/template/user/master/eticaret.Master" AutoEventWireup="true" CodeBehind="ustKategori.aspx.cs" Inherits="eticaret.template.user.page.ustKategori" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../css/UstKategori.css" rel="stylesheet" />
               ...
               <div class="col-2 ">
                 ...
                 <div class="col-12 ">
                   ...
                   <div class="boyut">
                             ...
                             <asp:Repeater ID="rptUstKategori" runat="server" >

                                <ItemTemplate>
                                         <div class="col-12 ">
                                            <div class="subMenu"> 
                                                <p><a href="kategori.aspx?ustKatID=<%# Eval("UstKategoriID") %>&durum=0"> <%# Eval("UstKategoriAdi") %></a></p>
                                            </div>
                                         </div>
                                 </ItemTemplate>
                             </asp:Repeater>   
                        ...
                        <div class="col-11 ilanPanel">
                          ...
                          <div class="col-12 ilanList">
                            <div class="col-12 ilanListHeader ">
                                ...
                                <div class="IilanBaslik"><p><a class="b" href="ilanGoruntule.aspx?ilanID=<%# Eval("ilanID") %>"> <%# Eval("ilanAdi") %></a></p></div>
