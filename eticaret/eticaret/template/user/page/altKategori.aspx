<%@ Page Title="" Language="C#" MasterPageFile="~/template/user/master/eticaret.Master" AutoEventWireup="true" CodeBehind="altKategori.aspx.cs" Inherits="eticaret.template.user.page.altKategori" %>
                   ...
                   <div class="boyut">
                             <asp:Repeater ID="rptAltKategori" runat="server" >
                                ...
                                <ItemTemplate>
                                         <div class="col-12 ">
                                            <div class="subMenu"> 
                                                <p><a href="ilanListele.aspx?altKatID=<%# Eval("altKategoriID") %>&durum=0"> <%# Eval("altKategoriAdi") %></a></p>
                                            </div>
                                         </div>
                                 </ItemTemplate>
                             </asp:Repeater>   
